<header class="w-full bg-white mb-10 border-b border-grey">
  <nav class="container flex flex-col md:flex-row justify-between items-center gap-0 md:gap-6 py-2 text-center">
    <div class="order-2 md:order-1 flex uppercase font-medium text-xs md:-ml-5 flex-1 w-full md:w-auto justify-center md:justify-start">
    ...
    <h1 class="order-1 md:order-2 font-medium uppercase justify-self-center w-full md:w-auto p-4 md:p-0">@yield('title')</h1>
