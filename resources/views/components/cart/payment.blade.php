<section class="max-w-2xl mx-auto grid md:grid-cols-4 gap-5 uppercase mb-12">
  <article class="border border-black rounded-xl p-7 pb-6 flex flex-col relative cursor-pointer overflow-hidden">
    ...
    <div class="absolute bottom-0 right-0 bg-black flex items-center justify-center px-3 py-2 rounded-tl-xl">
      <img class="w-3" src="{{ asset('assets/icons/done.svg') }}" alt="done">
    </div>
  </article>

  <article
    class="border border-grey hover:border-black transition-all rounded-xl p-7 flex flex-col relative cursor-pointer">
    <div class="flex flex-col items-center">
      <img class="w-55p h-55p rounded-xl mb-2.5" src="{{ asset('assets/images/placeholder.png') }}" alt="placeholder">
