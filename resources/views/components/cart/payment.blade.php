<section class="max-w-2xl mx-auto grid md:grid-cols-4 gap-5 uppercase mb-12">
  ...
  <label for="online" class="border border-grey hover:border-black transition-all rounded-xl p-7 flex flex-col relative cursor-pointer overflow-hidden">
  ...
  <label for="bank_transfer" class="border border-grey hover:border-black transition-all rounded-xl p-7 flex flex-col relative cursor-pointer overflow-hidden">
    <div class="flex flex-col items-center">
      <img class="w-55p h-55p rounded-xl mb-2.5" src="{{ asset('assets/images/placeholder.png') }}" alt="placeholder">
  ...
  <label for="google_pay" class="border border-grey hover:border-black transition-all rounded-xl p-7 flex flex-col relative cursor-pointer overflow-hidden">
    <div class="flex flex-col items-center">
      <img class="w-55p h-55p rounded-xl mb-2.5" src="{{ asset('assets/images/placeholder.png') }}" alt="placeholder">
