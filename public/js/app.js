...
var clearErrors = function clearErrors() {
  ...
  errors === null || errors === void 0 ? void 0 : errors.forEach(function (elem) {
    return elem === null || elem === void 0 ? void 0 : elem.remove();
  });
};

closeSigninModal === null || closeSigninModal === void 0 ? void 0 : closeSigninModal.addEventListener('click', function () {
...
function handleParamRemoving(removeParamClass) {
  var params = document.getElementsByClassName(removeParamClass);
...
function initializePriceSlider() {
  ...
  handlesSlider.noUiSlider.on('update', function (values) {
    nonLinearStepSliderValueElement.querySelector('#price-min').textContent = "".concat((+values[0]).toFixed(0), " \u20AC");
...
function handleOrder() {
  var filterOrder = document.getElementById('filter-order');
  var param = urlParams.get('o');
  filterOrder.value = param || 'updated_at-desc';
  filterOrder.addEventListener('change', function (event) {
...
if (!!input) autocompleter__WEBPACK_IMPORTED_MODULE_0___default()({
  ...
  fetch: function (_fetch) {
    ...
    return fetch("/search?query=".concat(query)).then(function (res) {
      return res.json();
    })["catch"](function () {
  ...
  render: function render(item) {
    var _item$subcategory, _item$subcategory$cat, _item$images, _item$variant$price, _item$variant;

    var a = document.createElement('a');
    a.href = "/".concat(item === null || item === void 0 ? void 0 : (_item$subcategory = item.subcategory) === null || _item$subcategory === void 0 ? void 0 : (_item$subcategory$cat = _item$subcategory.category) === null || _item$subcategory$cat === void 0 ? void 0 : _item$subcategory$cat.name, "/").concat(item === null || item === void 0 ? void 0 : item.id);
    var img = document.createElement('img');
    img.src = item === null || item === void 0 ? void 0 : (_item$images = item.images) === null || _item$images === void 0 ? void 0 : _item$images[0];
    a.appendChild(img);
    var p = document.createElement('p');
    p.innerText = item === null || item === void 0 ? void 0 : item.name;
    var span = document.createElement('span');
    span.innerText = "from ".concat((_item$variant$price = +(item === null || item === void 0 ? void 0 : (_item$variant = item.variant) === null || _item$variant === void 0 ? void 0 : _item$variant.price)) === null || _item$variant$price === void 0 ? void 0 : _item$variant$price.toFixed(2), "\u20AC");
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/nouislider/dist/nouislider.css":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/nouislider/dist/nouislider.css ***!
  \***************************************************************************************************************************************************************************************************************/
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwtech_eshop"] = self["webpackChunkwtech_eshop"] || [];
